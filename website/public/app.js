...
const TRANSLATIONS = {
  fr: {
    ...
    error_invalid: 'Entre un numéro valide avec le code pays. Ex: 242053323191',
  ...
  en: {
    ...
    social_group: '👥 Group',
    footer: null,
    error_invalid: 'Enter a valid number with country code. Ex: 242053323191',
  ...
  es: {
    ...
    social_group: '👥 Grupo',
    footer: null,
    error_invalid: 'Introduce un número válido con código de país. Ej: 242053323191',
  ...
  zh: {
    ...
    social_group: '👥 群组',
    footer: null,
    error_invalid: '请输入包含国家代码的有效号码。例：242053323191',
  ...
  hi: {
    ...
    social_group: '👥 ग्रुप',
    footer: null,
    error_invalid: 'देश कोड सहित एक वैध नंबर दर्ज करें। जैसे: 242053323191',
  ...
  ar: {
    ...
    footer: null,
    error_invalid: 'أدخل رقمًا صالحًا مع رمز الدولة. مثال: 242053323191',
  ...
  pt: {
    ...
    social_group: '👥 Grupo',
    footer: null,
    error_invalid: 'Digite um número válido com código do país. Ex: 242053323191',
  ...
  ru: {
    ...
    social_group: '👥 Группа',
    footer: null,
    error_invalid: 'Введите действительный номер с кодом страны. Пример: 242053323191',
  ...
  bn: {
    ...
    social_group: '👥 গ্রুপ',
    footer: null,
    error_invalid: 'দেশের কোড সহ একটি বৈধ নম্বর দিন। যেমন: 242053323191',
  ...
  id: {
    ...
    social_group: '👥 Grup',
    footer: null,
    error_invalid: 'Masukkan nomor yang valid dengan kode negara. Mis: 242053323191',
